...
logic write;
logic valid_out;
assign valid_out = s_axilite_rvalid;
logic [31:0] data;
logic wr_complete;
assign wr_complete = s_axilite_bvalid;
logic [1:0] rresp;
assign rresp = s_axilite_rresp;
logic [1:0] bresp;
assign bresp = s_axilite_bresp;
logic wready;
assign wready = s_axilite_wready;
