...
# Description:
#       This script prepares the simulation block design in Vivado.

# New simulation project
create_project $::env(SIM_PROJECT) . -force -part $::env(NOV_XILINX_PART_NUMBER)

# Addding IP path
set_property ip_repo_paths $::env(NOV_XILINX_IPS)/$::env(IP_NAME)/build [current_project]
update_ip_catalog
...
# Change some properties for the master AXI VIP (AXI VIP -> AXI-LITE slave)
...
# Change some properties for the slave AXI VIP (AXI master -> AXI VIP)
